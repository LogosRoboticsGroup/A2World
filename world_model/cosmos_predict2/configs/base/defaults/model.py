...
from cosmos_predict2.configs.base.config_multiview_action import get_cosmos_predict2_multiview_pipeline as get_cosmos_predict2_multiview_action_pipeline
...
from cosmos_predict2.models.video2world_multiview_action_model import (
    Predict2Video2WorldActionConditionedMultiviewModel,
    Predict2ActionConditionedMultiviewModelConfig,
)
from cosmos_predict2.models.video2world_multiview_action_state_pred_model import Predict2Video2WorldActionConditionedMultiviewStatePredModel
from cosmos_predict2.models.video2world_multiview_action_state_pred_model import Predict2ActionConditionedMultiviewModelConfig as Predict2ActionConditionedMultiviewStatePredModelConfig
...
# 2b model configs for predict2 action-conditioned multiview generation
_PREDICT2_MULTIVIEW_FSDP_2B_720P_10FPS_3VIEWS_21FRAMES = dict(
    trainer=dict(
        distributed_parallelism="fsdp",
    ),
    model=L(Predict2Video2WorldActionConditionedMultiviewModel)(
        config=Predict2ActionConditionedMultiviewModelConfig(
            pipe_config=get_cosmos_predict2_multiview_action_pipeline(
...
# 2b model configs for predict2 action-conditioned multiview generation and state prediction
_PREDICT2_MULTIVIEW_FSDP_2B_720P_10FPS_3VIEWS_21FRAMES_STATE_PRED = dict(
    trainer=dict(
        distributed_parallelism="fsdp",
    ),
    model=L(Predict2Video2WorldActionConditionedMultiviewStatePredModel)(
        config=Predict2ActionConditionedMultiviewStatePredModelConfig(
...
def register_model() -> None:
    ...
    cs.store(
        group="model",
        package="_global_",
        name="predict2_multiview_fsdp_2b_720p_10fps_3views_21frames",
        node=_PREDICT2_MULTIVIEW_FSDP_2B_720P_10FPS_3VIEWS_21FRAMES,
    )
    cs.store(
        group="model",
        package="_global_",
        name="predict2_multiview_fsdp_2b_720p_10fps_3views_21frames_state_pred",
        node=_PREDICT2_MULTIVIEW_FSDP_2B_720P_10FPS_3VIEWS_21FRAMES_STATE_PRED,
    )
