...
from cosmos_predict2.conditioner import BooleanFlag, ConditionLocation, ReMapkey, TextAttr
from cosmos_predict2.conditioner import MultiViewConditioner, ActionBlackHistoryMultiviewConditioner, ActionBlackHistoryStateMultiviewConditioner
...
from cosmos_predict2.models.video2world_multiview_action_dit import ActionConditionedMultiViewDiT
from cosmos_predict2.models.video2world_multiview_action_state_pred_dit import ActionConditionedMultiViewStatePredDiT
...
class MultiviewPipelineConfig:
    ...
    conditioner: LazyDict[ActionBlackHistoryMultiviewConditioner]
    ...
    net: LazyDict[ActionConditionedMultiViewDiT]
...
@make_freezable
@attrs.define(slots=False)
class MultiviewStatePredPipelineConfig:
    adjust_video_noise: bool
    conditioner: LazyDict[ActionBlackHistoryStateMultiviewConditioner]
    conditioning_strategy: str
    min_num_conditional_frames_per_view: int
    max_num_conditional_frames_per_view: int
    condition_locations: list[ConditionLocation]
    ...
    # n_cameras_emb: int
    sigma_conditional: float
    net: LazyDict[ActionConditionedMultiViewStatePredDiT]
    tokenizer: LazyDict[TokenizerInterface]
    prompt_refiner_config: CosmosReason1Config
    guardrail_config: CosmosGuardrailConfig
    precision: str
...
_PREDICT2_MULTIVIEW_NET_2B_10FPS_3VIEWS_21FRAMES = L(ActionConditionedMultiViewDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
    ...
    rope_h_extrapolation_ratio=3.0,
    rope_w_extrapolation_ratio=3.0,
    rope_t_extrapolation_ratio=6.0 / 24.0,
    extra_per_block_abs_pos_emb=False,
    rope_enable_fps_modulation=False,
    sac_config=L(SACConfig)(
        every_n_blocks=1,
    ...
    n_cameras_emb=4,
    view_condition_dim=7,
    concat_view_embedding=True, # if True, the pretrained x_embedder cant be used
    # extra for action condition
    action_dim=14 * (21 - 1), # 14 * (13 - 1)
    use_black=True,
    use_history=False,
)

_PREDICT2_MULTIVIEW_NET_2B_10FPS_3VIEWS_21FRAMES_STATE_PRED = L(ActionConditionedMultiViewStatePredDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
_PREDICT2_MULTIVIEW_PIPELINE_2B_10FPS_3VIEWS_21FRAMES = MultiviewPipelineConfig(
    adjust_video_noise=True,
    conditioner=L(ActionBlackHistoryMultiviewConditioner)(
        fps=L(ReMapkey)(
            dropout_rate=0.0,
            dtype=None,
            input_key="fps",
    ...
    max_num_conditional_frames_per_view=1,
    condition_locations=[ConditionLocation.FIRST_RANDOM_N],
    net=_PREDICT2_MULTIVIEW_NET_2B_10FPS_3VIEWS_21FRAMES,
    precision="bfloat16",
    rectified_flow_t_scaling_factor=1.0,
    resize_online=True,
    resolution="720",
...
_PREDICT2_MULTIVIEW_PIPELINE_2B_10FPS_3VIEWS_21FRAMES_STATE_PRED = MultiviewStatePredPipelineConfig(
    adjust_video_noise=True,
    conditioner=L(ActionBlackHistoryStateMultiviewConditioner)(
        fps=L(ReMapkey)(
            dropout_rate=0.0,
            dtype=None,
            input_key="fps",
    ...
    min_num_conditional_frames_per_view=1,
    max_num_conditional_frames_per_view=1,
    condition_locations=[ConditionLocation.FIRST_RANDOM_N], # [ConditionLocation.FIRST_THIRD_VIEW_CAM],
    net=_PREDICT2_MULTIVIEW_NET_2B_10FPS_3VIEWS_21FRAMES_STATE_PRED,
    precision="bfloat16",
    rectified_flow_t_scaling_factor=1.0,
    resize_online=True,
    resolution="720",
...
_PREDICT2_MULTIVIEW_PIPELINE_2B_720P_10FPS_3VIEWS_21FRAMES = deepcopy(
    _PREDICT2_MULTIVIEW_PIPELINE_2B_10FPS_3VIEWS_21FRAMES
)

_PREDICT2_MULTIVIEW_PIPELINE_2B_720P_10FPS_3VIEWS_21FRAMES_STATE_PRED = deepcopy(
    _PREDICT2_MULTIVIEW_PIPELINE_2B_10FPS_3VIEWS_21FRAMES_STATE_PRED
)
...
@dataclasses.dataclass(frozen=True)
class _MultiviewStatePredPipelineConfig:
    model_size: CosmosPredict2Video2WorldModelSize
    resolution: CosmosPredict2MultiviewResolution
    fps: CosmosPredict2MultiviewFPS
    views: dataclasses.field(default=CosmosPredict2MultiviewViews, kw_only=True)
...
_PREDICT2_MULTIVIEW_PIPELINES: dict[
    ...
    _MultiviewPipelineConfig(
        "2B", "720", 10, views=3, frames=21
    ): _PREDICT2_MULTIVIEW_PIPELINE_2B_720P_10FPS_3VIEWS_21FRAMES,
}

_PREDICT2_MULTIVIEW_STATE_PRED_PIPELINES: dict[
    _MultiviewStatePredPipelineConfig,
    MultiviewStatePredPipelineConfig,
] = {
    _MultiviewStatePredPipelineConfig(
        "2B", "720", 10, views=3, frames=21
    ): _PREDICT2_MULTIVIEW_PIPELINE_2B_720P_10FPS_3VIEWS_21FRAMES_STATE_PRED,
}
...
def get_cosmos_predict2_multiview_state_pred_pipeline(
    *,
    model_size: CosmosPredict2Video2WorldModelSize,
    views: CosmosPredict2MultiviewViews,
    frames: CosmosPredict2MultiviewFrames,
    ...
    key = _MultiviewStatePredPipelineConfig(model_size, resolution, fps, views=views, frames=frames)
    return _PREDICT2_MULTIVIEW_STATE_PRED_PIPELINES[key]
