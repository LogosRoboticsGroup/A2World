...
class MultiViewCrossAttention(Attention):
    ...
    def forward(self, x, context=None, rope_emb=None):
        ...
        # context = None # I think it's useless
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.concat_view_embedding:
            ...
            self.view_embeddings = nn.Embedding(4, view_condition_dim) # we need to unify across multiple datasets, 0, 1 represents two wrist cameras, and 1, 2 represents two third-view cameras.
