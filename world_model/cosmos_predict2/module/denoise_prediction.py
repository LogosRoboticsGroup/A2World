...
@dataclass
class DenoisePredictionJoint:
    x0_video: torch.Tensor          # (B,C,T,H,W)
    eps_video: torch.Tensor         # (B,C,T,H,W)
    x0_action: torch.Tensor         # (B,Ta,D)
    eps_action: torch.Tensor        # (B,Ta,D)
